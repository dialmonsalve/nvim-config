...
opt.smartcase = true -- if you include mixed case in your seacrh, assumes you want case-sensitive

opt.cursorline = false

--turn on termguiscolor for tokyonight colorscheme to work
-- (have to use iterm2 or any other true color terminal)
opt.termguicolors = true
opt.background = "dark" -- colorshemes that can be light or dark will be made dark
opt.signcolumn = "yes" --show sign column so that text doen't shift
